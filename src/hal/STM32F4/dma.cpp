...
static DMA_Stream_TypeDef *const stream_list
	[static_cast<uint8_t>(dma::dma_t::DMA_END)]
	[static_cast<uint8_t>(dma::stream_t::STREAM_END)] =
{
	{
...
static IRQn_Type const irq_list
	[static_cast<uint8_t>(dma::dma_t::DMA_END)]
	[static_cast<uint8_t>(dma::stream_t::STREAM_END)] =
{
	{
...
static volatile uint32_t *const isr_list
	[static_cast<uint8_t>(dma::dma_t::DMA_END)]
	[static_cast<uint8_t>(dma::stream_t::STREAM_END)] =
{
	{
...
static volatile uint32_t *const isr_clr_list
	[static_cast<uint8_t>(dma::dma_t::DMA_END)]
	[static_cast<uint8_t>(dma::stream_t::STREAM_END)] =
{
	{
...
static uint32_t const isr_shift_list
	[static_cast<uint8_t>(dma::stream_t::STREAM_END)] =
{
	0, 6, 16, 22, 0, 6, 16, 22
};
	...
	_cb(NULL)
{
	...
	obj_list[static_cast<uint8_t>(_dma)][static_cast<uint8_t>(_stream)] = this;
	
	RCC->AHB1ENR |= (_dma == dma_t::DMA_1) ? RCC_AHB1ENR_DMA1EN : RCC_AHB1ENR_DMA2EN;
	
	DMA_Stream_TypeDef *dma_stream = stream_list[static_cast<uint8_t>(_dma)]
		[static_cast<uint8_t>(_stream)];
	dma_stream->CR &= ~DMA_SxCR_EN;
	
	/* Clear isr reg flags */
	volatile uint32_t *isr_clr_reg = isr_clr_list[static_cast<uint8_t>(dma)]
		[static_cast<uint8_t>(stream)];
	*isr_clr_reg = (DMA_LIFCR_CFEIF0 | DMA_LIFCR_CDMEIF0 | DMA_LIFCR_CTEIF0 |
		DMA_LIFCR_CHTIF0 | DMA_LIFCR_CTCIF0) << isr_shift_list[static_cast<uint8_t>(_stream)];
	
	/* Setup channel */
	dma_stream->CR &= ~DMA_SxCR_CHSEL;
	dma_stream->CR |= static_cast<uint8_t>(ch) << CHSEL_OFFSET;
	...
	NVIC_SetPriority(irq_list[static_cast<uint8_t>(_dma)]
		[static_cast<uint8_t>(_stream)], IRQ_PRIORITY);
	NVIC_EnableIRQ(irq_list[static_cast<uint8_t>(_dma)]
		[static_cast<uint8_t>(_stream)]);
}
...
{
	/* Only DMA2 is able to perform memory-to-memory transfers */
	ASSERT(dir != dir_t::DIR_MEM_TO_MEM || _dma != dma_t::DMA_1);
...
void dma::start_once(dma_cb_t cb, void *ctx)
{
	...
	volatile uint32_t *isr_clr_reg = isr_clr_list[static_cast<uint8_t>(_dma)]
		[static_cast<uint8_t>(_stream)];
	*isr_clr_reg = DMA_LIFCR_CTCIF0 << isr_shift_list[static_cast<uint8_t>(_stream)];
	NVIC_EnableIRQ(irq_list[static_cast<uint8_t>(_dma)][static_cast<uint8_t>(_stream)]);
	dma_stream->CR |= DMA_SxCR_EN;
}
...
void dma::stop()
{
	...
	NVIC_DisableIRQ(irq_list[static_cast<uint8_t>(_dma)][static_cast<uint8_t>(_stream)]);
	dma_stream->CR &= ~DMA_SxCR_EN;
...
{
	DMA_Stream_TypeDef *dma_stream = stream_list[static_cast<uint8_t>(obj->_dma)]
		[static_cast<uint8_t>(obj->_stream)];
	
	uint32_t isr = *isr_list[static_cast<uint8_t>(obj->_dma)]
		[static_cast<uint8_t>(obj->_stream)];
	
	volatile uint32_t *isr_clr_reg = isr_clr_list[static_cast<uint8_t>(obj->_dma)]
		[static_cast<uint8_t>(obj->_stream)];
	
	uint8_t shift = isr_shift_list[static_cast<uint8_t>(obj->_stream)];
	...
	if((dma_stream->CR & DMA_SxCR_TCIE) && (isr & (DMA_LISR_TCIF0 << shift)))
	{
		*isr_clr_reg = DMA_LIFCR_CTCIF0 << shift;
		...
		if(obj->_cb)
			obj->_cb(obj, dma::event_t::EVENT_CMPLT, obj->_ctx);
	}
		...
		(isr & (DMA_LISR_HTIF0 << shift)))
	{
		*isr_clr_reg = DMA_LIFCR_CHTIF0 << shift;
		if(obj->_cb)
			obj->_cb(obj, dma::event_t::EVENT_HALF, obj->_ctx);
	}
		...
		(isr & (DMA_LISR_TEIF0 << shift)))
	{
		*isr_clr_reg = DMA_LIFCR_CTEIF0 << shift;
		...
		if(obj->_cb)
			obj->_cb(obj, dma::event_t::EVENT_ERROR, obj->_ctx);
	}
}

extern "C" void DMA1_Stream0_IRQHandler(void)
{
	dma_irq_hndlr(obj_list[static_cast<uint8_t>(dma::dma_t::DMA_1)]
		[static_cast<uint8_t>(dma::stream_t::STREAM_0)]);
}

extern "C" void DMA1_Stream1_IRQHandler(void)
{
	dma_irq_hndlr(obj_list[static_cast<uint8_t>(dma::dma_t::DMA_1)]
		[static_cast<uint8_t>(dma::stream_t::STREAM_1)]);
}

extern "C" void DMA1_Stream2_IRQHandler(void)
{
	dma_irq_hndlr(obj_list[static_cast<uint8_t>(dma::dma_t::DMA_1)]
		[static_cast<uint8_t>(dma::stream_t::STREAM_2)]);
}

extern "C" void DMA1_Stream3_IRQHandler(void)
{
	dma_irq_hndlr(obj_list[static_cast<uint8_t>(dma::dma_t::DMA_1)]
		[static_cast<uint8_t>(dma::stream_t::STREAM_3)]);
}

extern "C" void DMA1_Stream4_IRQHandler(void)
{
	dma_irq_hndlr(obj_list[static_cast<uint8_t>(dma::dma_t::DMA_1)]
		[static_cast<uint8_t>(dma::stream_t::STREAM_4)]);
}

extern "C" void DMA1_Stream5_IRQHandler(void)
{
	dma_irq_hndlr(obj_list[static_cast<uint8_t>(dma::dma_t::DMA_1)]
		[static_cast<uint8_t>(dma::stream_t::STREAM_5)]);
}

extern "C" void DMA1_Stream6_IRQHandler(void)
{
	dma_irq_hndlr(obj_list[static_cast<uint8_t>(dma::dma_t::DMA_1)]
		[static_cast<uint8_t>(dma::stream_t::STREAM_6)]);
}

extern "C" void DMA1_Stream7_IRQHandler(void)
{
	dma_irq_hndlr(obj_list[static_cast<uint8_t>(dma::dma_t::DMA_1)]
		[static_cast<uint8_t>(dma::stream_t::STREAM_7)]);
}

extern "C" void DMA2_Stream0_IRQHandler(void)
{
	dma_irq_hndlr(obj_list[static_cast<uint8_t>(dma::dma_t::DMA_2)]
		[static_cast<uint8_t>(dma::stream_t::STREAM_0)]);
}
