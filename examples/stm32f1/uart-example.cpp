...
int main(int argc, char *argv[])
{
    ...
    // UART1 interface
    periph::gpio_stm32f1 uart1_tx(periph::gpio_stm32f1::port::a, 9, periph::gpio::mode::alternate_function);
    periph::gpio_stm32f1 uart1_rx(periph::gpio_stm32f1::port::a, 10, periph::gpio::mode::alternate_function);
    periph::dma_stm32f1 uart1_tx_dma(1, 4, periph::dma_stm32f1::direction::memory_to_periph, 8);
    periph::dma_stm32f1 uart1_rx_dma(1, 5, periph::dma_stm32f1::direction::periph_to_memory, 8);
    periph::uart_stm32f1 uart1(1, 115200, periph::uart_stm32f1::stopbits::stopbits_1, periph::uart_stm32f1::parity::none,
