...
static exti_stm32f4 *obj_list[gpio_hw_mapping::pins];
...
exti_stm32f4::exti_stm32f4(gpio_stm32f4 &gpio, enum trigger trigger):
    gpio(gpio),
    _trigger(trigger)
{
...
void exti_stm32f4::trigger(enum trigger trigger)
{
    _trigger = trigger;
